...
[Modeling a parametric tree in Grasshopper](https://youtu.be/pV7G3abiA1I) + [parametric-tree.gh](https://github.com/baharmon/baharmon.github.io/blob/master/data/parametric-tree.gh?raw=true)

[<i class="fab fa-youtube"></i>](https://youtu.be/Y9H4kW3GJ-w)
[<i class="fab fa-vimeo-v"></i>]()
[Modeling a linear array of trees in Grasshopper](https://youtu.be/Y9H4kW3GJ-w) + [linear-array.gh](https://github.com/baharmon/baharmon.github.io/blob/master/data/linear-array.gh?raw=true)
