...
Set your computational region to landforms
...
Use [r.colors](https://grass.osgeo.org/grass78/manuals/r.colors.html)
...
Add a legend with [d.legend](https://grass.osgeo.org/grass78/manuals/d.legend.html).
```
