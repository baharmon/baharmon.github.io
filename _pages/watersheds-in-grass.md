...
[r.import](https://grass.osgeo.org/grass78/manuals/r.import.html)
and [r.patch](https://grass.osgeo.org/grass78/manuals/r.patch.html).
...
For [r.in.usgs](https://grass.osgeo.org/grass78/manuals/addons/r.in.usgs.html)
...
with the module [r.to.vect](https://grass.osgeo.org/grass78/manuals/r.to.vect)
and then extract the basin of interest with
[v.extract](https://grass.osgeo.org/grass78/manuals/v.extract)
...
Then use [g.extension](https://grass.osgeo.org/grass78/manuals/g.extension.html)
...
with [d.vect](https://grass.osgeo.org/grass78/manuals/d.vect.html).
...
[v.colors](https://grass.osgeo.org/grass78/manuals/v.colors.html).
