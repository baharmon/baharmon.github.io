...
| Digital Surface Model, Governor's Island, NYC |
|:---:|
| ![Digital Surface Model, Governor's Island, NYC](/images/governors_island/surface.png) |
...
1. [Slope](#slope)
1. [Categorized Slope](#categorized-slope)
1. [Contours](#contours)
1. [Hillshade](#hillshade)
1. [Skyview Factor](#skyview-factor)
1. [Cartography](#cartogaphy)
...
Data sources include https://orthos.dhses.ny.gov/
and https://data.cityofnewyork.us/.
...
| Slope |
|:---:|
| ![](/images/governors_island/slope.png) |
...
| Categorized Slope |
|:---:|
| ![](/images/governors_island/categorized_slope.png) |
...
|:---:|
| ![Digital elevation model with 3 ft contours](/images/governors_island/contours.png) |
...
|:---:|
| ![Shaded relief map](/images/governors_island/shaded_relief.png) |
...
| Skyview Factor |
|:---:|
| ![Skyview factor](/images/governors_island/skyview.png) |

| Digital Surface Model with Skyview Shading |
|:---:|
| ![Surface map with skyview shading](/images/governors_island/composite_surface.png) |
...
|:---:|
| ![Shaded relief map with cartographic grid](/images/governors_island/shaded_relief_grid.png) |
...
|:---:|:---:|:---:|
| ![Digital surface model with shaded relief](/images/governors_island/surface.png) | ![Slope with shaded relief](/images/governors_island/shaded_slope.png) | ![Categorized slope with shaded relief](/images/governors_island/shaded_categorized_slope.png) |
