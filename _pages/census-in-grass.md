...
[v.in.ogr](https://grass.osgeo.org/grass78/manuals/v.in.ogr.html).
Then import and reproject the census tract boundaries for the state of New York
with [v.import](https://grass.osgeo.org/grass78/manuals/v.import.html).
Clip the census tract boundaries to the boroughs with
[v.clip](https://grass.osgeo.org/grass78/manuals/v.clip.html).
Import `population.csv` as a table with
[db.in.ogr](https://grass.osgeo.org/grass78/manuals/db.in.ogr.html)
and then join this table to the census tracts' attribute table
with [v.db.join](https://grass.osgeo.org/grass78/manuals/v.db.join.html).
...
[v.db.addcolumn](https://grass.osgeo.org/grass78/manuals/v.db.addcolumn.html)
and then copy the population values
from the text column to the new numeric column with
[v.db.update](https://grass.osgeo.org/grass78/manuals/v.db.update.html).
For [v.db.update](https://grass.osgeo.org/grass78/manuals/v.db.update.html)
...
with [v.colors](https://grass.osgeo.org/grass78/manuals/v.colors.html).
...
Then use [v.db.update](https://grass.osgeo.org/grass78/manuals/v.db.update.html)
...
Optionally use
[d.vect.chart](https://grass.osgeo.org/grass78/manuals/d.vect.chart.html)
...
[m.printws](https://grass.osgeo.org/grass78/manuals/addons/m.printws.html)
...
run [m.printws](https://grass.osgeo.org/grass78/manuals/addons/m.printws.html)
...
[v.to.rast](https://grass.osgeo.org/grass78/manuals/v.to.rast.html)
...
Use [v.select](https://grass.osgeo.org/grass78/manuals/v.select.html)
