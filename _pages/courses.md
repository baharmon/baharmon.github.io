...
title: Courses
subtitle:
description: Open educational materials for spatial science and computational design
...
**[Course Datasets](datasets)**

* <i class="ms ms-grass-gis"></i>
[Natural Earth Dataset for GRASS](https://zenodo.org/record/3762852/files/natural-earth-dataset.zip?download=1)
* <i class="ms ms-grass-gis"></i>
[Governor's Island Dataset for GRASS](https://zenodo.org/record/3940780/files/nyspf_govenors_island.zip?download=1)
...
## [Tutorials](hhttps://baharmon.github.io/tutorials)

**[Computational Design](hhttps://baharmon.github.io/tutorials)**

A collection of tutorials teaching creative computation with Grasshopper and Python:

* [Random walk with Grasshopper	](https://baharmon.github.io/tutorials/design/random-walk-01.html)
* [Random walk with NumPy](https://baharmon.github.io/tutorials/design/random-walk-02.html)
* [Random walk with scripting in Grasshopper](https://baharmon.github.io/tutorials/design/random-walk-03.html)
* [3D random walk with NumPy](https://baharmon.github.io/tutorials/design/random-walk-04.html)

**[Geocomputation with GRASS](https://grass-tutorials.osgeo.org/)**

Official tutorials for the GRASS geocomputation engine:
...
A guide for using the landscape evolution model `r.sim.terrain` in GRASS.
